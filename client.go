...
// APIClient manages communication with the Sample API API v4.0.0
...
type APIClient struct {
	...
	VoucherSendMethodAPI *VoucherSendMethodAPIService

	VoucherStatusAPI *VoucherStatusAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.VoucherSendMethodAPI = (*VoucherSendMethodAPIService)(&c.common)
	c.VoucherStatusAPI = (*VoucherStatusAPIService)(&c.common)
