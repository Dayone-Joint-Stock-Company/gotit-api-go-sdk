...
// checks if the PRODUCTVENDORLINKG type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PRODUCTVENDORLINKG{}

// PRODUCTVENDORLINKG struct for PRODUCTVENDORLINKG
type PRODUCTVENDORLINKG struct {
...
type _PRODUCTVENDORLINKG PRODUCTVENDORLINKG
...
func (o PRODUCTVENDORLINKG) MarshalJSON() ([]byte, error) {
...
func (o PRODUCTVENDORLINKG) ToMap() (map[string]interface{}, error) {
...
func (o *PRODUCTVENDORLINKG) UnmarshalJSON(data []byte) (err error) {
	...
	varPRODUCTVENDORLINKG := _PRODUCTVENDORLINKG{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPRODUCTVENDORLINKG)

	if err != nil {
		return err
	}

	*o = PRODUCTVENDORLINKG(varPRODUCTVENDORLINKG)

	return err
}

type NullablePRODUCTVENDORLINKG struct {
	value *PRODUCTVENDORLINKG
	isSet bool
}

func (v NullablePRODUCTVENDORLINKG) Get() *PRODUCTVENDORLINKG {
	return v.value
}

func (v *NullablePRODUCTVENDORLINKG) Set(val *PRODUCTVENDORLINKG) {
	v.value = val
	v.isSet = true
}

func (v NullablePRODUCTVENDORLINKG) IsSet() bool {
	return v.isSet
}

func (v *NullablePRODUCTVENDORLINKG) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePRODUCTVENDORLINKG(val *PRODUCTVENDORLINKG) *NullablePRODUCTVENDORLINKG {
	return &NullablePRODUCTVENDORLINKG{value: val, isSet: true}
}

func (v NullablePRODUCTVENDORLINKG) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePRODUCTVENDORLINKG) UnmarshalJSON(src []byte) error {
	v.isSet = true
